...
void load_cv(void)
{
	...
	*/
	for (i = 0; i < 4; i++) {
		CV33_36[i] = read_cv_raw(33 + i);
		setFuncTable(CV33_36[i] & 0x1F);
		CV112_CV115[i] = read_cv_raw(112 + i);
	}
	CV45 = read_cv_raw(45);
...
*/
		...
		case 36:
		case 37:
			CV33_36[CVnum2 - 33] = data;
			setFuncTable(CV33_36[CVnum2 - 33] & 0x1F);
			break;
		case 45:
			CV45 = data;
			setFuncTable(CV45 & 0x1F);
